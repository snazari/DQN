...
#Virtual environment
#To work with tensorflow, it is recommended to use a virtual environment.
#To create a virtual environment, run the command
python3.6 -m venv ~/venv/ddqn
#Activate the virtual environment with the following command
source ~/venv/ddqn/bin/activate

#If you use conda, then you need to activate the virtual environment anaconda:
...
#The code implements a class (from dqnn.py) for learning DDQN, which is built into the cross-validation class. To run cross-validation, execute the following code:
