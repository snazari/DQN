...
if __name__ == '__main__':
    ...
    a1 = env.observation_space.shape
    a2 = env.action_space.n
    ...
    test_mode = False
    model_path = os.path.abspath('~/repos/python_deep_reinforcement_sequence/DQN/pretrained/Seaquest-10M.ckpt')
